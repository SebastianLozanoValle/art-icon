    ...
    return (
        <section className="py-12 px-6 text-white">
            <div className="container mx-auto relative">
                ...
                <div className={`grid grid-cols-1 overflow-hidden md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 py-10 transition-all duration-500 ${isExpanded ? 'max-h-[2160px]' : 'max-h-[180px]'}`}>
